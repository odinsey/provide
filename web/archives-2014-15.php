...
<title>Collège La Providence - Olivet - Sorties pédagogiques 2014-2015</title>
<!-- InstanceEndEditable -->
            ...
            <div id="site">                
                ...
                <div id="colonne-droite">
                	<div id="titre"><!-- InstanceBeginEditable name="Titre-Contenu" -->
                    	Soties pédagogiques 2014 - 2015 (archives)
					<!-- InstanceEndEditable -->
                  </div>
                  <div id="contenu">
...
require_once("php/req_func.php");
	$today=date("m/d/Y");
	$debut=explode("/","08/30/2014");
	$debut=$debut[2].$debut[0].$debut[1];
	$fin=explode("/","07/01/2015");
