...
<title>Collège La Providence - Olivet - Historique</title>
<!-- InstanceEndEditable -->
    	...
    	<div id="wrapper-haut">
            ...
            <div id="site">                
                ...
                <div id="colonne-droite">
                    ...
                    Histoire des Etablissements Catholiques d’Enseignement à OLIVET
					<!-- InstanceEndEditable -->
                  </div>
                  <div id="contenu">
				  <!-- InstanceBeginEditable name="Contenu" -->
<h2>1)	La présence mouvementée des sœurs de La PROVIDENCE  à  OLIVET</h2>

<p><strong>Les Sœurs de la Providence de Ruillé-sur-Loir</strong>, dans la Sarthe sont appelées à Olivet en <strong>1844</strong>, par M. de Mainville, maire de cette commune. Elles dirigent l'école communale jusqu'en <strong>1848</strong>. Elles sont au nombre de trois : une pour visiter les malades et les deux autres pour faire l'école aux enfants de la paroisse (160 enfants).</p>
<ul>
...
<ul>
    ...
    <li>En <strong>1864</strong>, les religieuses sont autorisées à ouvrir un internat.</li>
</ul>
<p>Grâce aux bienfaiteurs, les sœurs ont bénéficié de moyens d’existence, puisqu’en <strong>1885</strong>, Sœur Anne-Marie déclare en mairie diriger l’asile dans un immeuble appartenant aux sœurs (11 ou 15 rue de la mairie) et en <strong>1898</strong>, elles sont habilitées pour un internat de 52 élèves.</p>
<ul>
	<li>Le 14 février <strong>1902</strong>, dans un contexte très anticlérical, le Conseil Municipal, lors d’une séance qui fut l’une des plus mouvementée de l’histoire d’Olivet, rejette la demande en autorisation des sœurs de La Providence. Les sœurs quittent l’école et le pays dans une ambiance tumultueuse, sous les cris de la foule : « Vive les sœurs » !</li>
    <li>Le 15 mai de la même année eut lieu la réouverture de classes pour les filles tenues par « Dames » religieuses sécularisées (elles reprennent l'habit civil). Les religieuses reprendront le costume en <strong>1940</strong> (gouvernement de Vichy).</li>
</ul>
<p>Grâce aux donateurs, des bâtiments sont construits, des propriétés achetées, pour y installer les sœurs de la Providence avec internat, externat et salle d’asile, sur des terrains situés entre la médiathèque actuelle et la rue des écoles.</p>
...
<p><strong>Sont donc implantés sur OLIVET deux Etablissements Scolaires Privés Catholiques :</strong></p>
<ul>
	<li>Au 91 rue du Général de Gaulle, l'école de filles, Notre-Dame de la Providence, sous la tutelle congréganiste des Sœurs de la Providence.</li>
    <li>Au 46 rue Pierre Beaulieu, 1'école de garçons, St Joseph, tenue par les frères des écoles chrétiennes puis par des laïcs, sous tutelle diocésaine.</li>
</ul>
<p>L'école des filles propose des classes maternelles, primaires, un cours complémentaire avec de la comptabilité, un enseignement ménager. L'école de garçons est essentiellement maternelle et primaire avec 3 classes, une classe accueillant parfois  54 élèves !</p>


<h2>3) Le collège, des années 1960 à nos jours.</h2>
<p>En <strong>1967</strong>, sous 1'égide du Père GREFFIN, Curé d'Olivet, les Sœurs de la Providence s'installent au 46 rue Pierre Beaulieu et restructurent 1'ensemble des Ecoles Catholiques de la ville.</p>
