...
<title>Collège La Providence - Olivet - Contacts et Accès</title>
<!-- InstanceEndEditable -->
    	...
    	<div id="wrapper-haut">
            ...
            <div id="site">                
                ...
                <div id="colonne-droite">
                    ...
                    CONTACTS ET PLAN D'ACCES
					<!-- InstanceEndEditable -->
                  </div>
                  <div id="contenu">
				  <!-- InstanceBeginEditable name="Contenu" -->
<ul>
	<li><strong>Collège La Providence</strong></li>
...
<div class="paragrapheOnOff">Les transports en commun</div>
<div class="accordeon">
	<h2>Les bus TAO</h2>
    	<ul>	
    ...
    <h2>Le tram</h2>
    	<ul>
        	<li>Ligne A : arrêt Olivet</li>
            <li>Pour en savoir plus : le site d'Olivet</li>
		</ul>            
</div>
