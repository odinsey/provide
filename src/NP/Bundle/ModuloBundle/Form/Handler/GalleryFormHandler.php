...
class GalleryFormHandler extends BaseEntityFormHandler {

    protected $class_name = 'NP\Bundle\ModuloBundle\Entity\Gallery';
        ...
        if (!$controller->get('security.context')->isGranted('ROLE_SUPER_ADMIN')) {
            ...
            $message = \Swift_Message::newInstance()
                    ...
                    $controller->renderView(
                        ...
                        'entity' => $form->getData(),
                        'fields' => $fields,
                        'route_edit' => 'np_modulo_admin_gallery_edit'
                            )
                    ), 'text/html', 'utf-8'
            );
