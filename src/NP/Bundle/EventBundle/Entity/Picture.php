...
class Picture {
	...
	'thumb' => array('width' => 146, 'height' => 82, 'thumbnail_type' => ImageInterface::THUMBNAIL_OUTBOUND),
	...
	return sprintf('sortie-%d/etape-%d', $this->getParent()->getParent()->getId(), $this->getParent()->getId());
    }
